...
- Re-create the CLDF dataset:
  ```shell
  cldfbench makecldf --glottolog-version v5.2 cldfbench_hruschka_et_al2015.py --with-zenodo --with-cldfreadme
  ```
...
- Re-create the README:
  ```shell
  cldfbench readme cldfbench_hruschka_et_al2015.py
  ```
- Run Phlorest-specific checks on the data:
  ```shell
  phlorest check --with-R cldfbench_hruschka_et_al2015.py
  ```
...
- Create the release instruction:
  ```shell
  phlorest release cldfbench_hruschka_et_al2015.py vX.Y
  ```
